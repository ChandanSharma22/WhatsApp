...
import com.ck.WhatsApp.databinding.ActivityGroupChatBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Group_Chat_Activity.this,MainActivity.class);
        ...
        binding.userNamee.setText("Group");
